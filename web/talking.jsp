...
<div class = "filtr" style="left: 230px">
    ...
    <button class = "buttonOkFiltr" style="left: 515px; top: -47px" onclick="filterTalking(phoneFiltr.value,
                cityFiltr.value, minFiltr.value, dateFiltr.value,timeFiltr.value, costFiltr.value)">ОК</button>
...
<div class="baseForm" id = "formTalking" style="display: none; width: 350px">
    ...
    <div class = "form" style="height: 250px">
        ...
        <button class = "buttonOk" style="left: 140px; top: 210px" onclick="addTalking(phoneSelect.options[phoneSelect.selectedIndex].text,
        citySelect.options[citySelect.selectedIndex].text,
        min.value, dateTalking.value, timeTalking.value, cost.value)">ОК</button>
    </div>
</div>
</body>
</html>
